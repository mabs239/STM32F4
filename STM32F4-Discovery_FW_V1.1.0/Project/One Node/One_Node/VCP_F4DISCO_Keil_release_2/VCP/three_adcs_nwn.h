...
/* Private variables ---------------------------------------------------------*/
__IO uint16_t aADCDualConvertedValue[3];
...
static void ADC3_CH1_Config(void);
...

{
 ...
 // ADC_RegularChannelConfig(ADC2, ADC_Channel_11, 1, ADC_SampleTime_3Cycles);
  ...
  ADC_RegularChannelConfig(ADC3, ADC_Channel_1, 1, ADC_SampleTime_144Cycles);
...

{
  ...
  GPIO_InitTypeDef GPIO_InitStructure,gpio2,gpioB,gpioA;
